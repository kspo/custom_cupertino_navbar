library custom_cupertino_navigation;
...
Widget _wrapWithBackground({
  ...
  if (updateSystemUiOverlay) {
    isDark = backgroundColor.computeLuminance() < 0.179;
...
/// behavior for multiple navigation bars per route.
///
/// `CustomCupertinoSliverNavigationBar` has its text scale factor set to 1.0 by default
...
/// `CustomCupertinoSliverNavigationBar`'s components inside a [MediaQuery] with the
...
class _LargeTitleNavigationBarSliverDelegate
  ...
  Widget build(
    ...
    return Hero(
      ...
      // CustomCupertinoSliverNavigationBar like CupertinoNavigationBar because it
...
// CustomCupertinoSliverNavigationBar. The KeyedSubtrees are inserted into static
